...
func RequestLoggingMiddleware(logger logging.RequestLogger) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		responseTiming := logging.NewResponseTiming()
		c.Set(logging.ResponseTimingGinKey, responseTiming)
		wrapper := NewResponseWriterWrapper(c.Writer, logger, requestInfo, responseTiming)
		if !loggerEnabled {

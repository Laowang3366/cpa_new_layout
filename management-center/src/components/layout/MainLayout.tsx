...
const sidebarIcons: Record<string, ReactNode> = {
  ...
  oauthConfig: <IconSidebarConfig size={18} />,
  quota: <IconSidebarQuota size={18} />,
  quotaGuardian: <IconShield size={18} />,
  ...
  const navGroups: SidebarNavGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        {
          path: '/oauth-config',
          labelKey: 'nav.oauth_config',
          metaKey: 'nav_meta.oauth_config',
          icon: sidebarIcons.oauthConfig,
        },
        ...(isApiKeyFunConfigured ? [quickStartNavItem] : []),
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          label: '额度守护',
          meta: '批量刷新与失效清理',
          icon: sidebarIcons.quotaGuardian,
        },
        {
          path: '/usage-records',
          labelKey: 'nav.usage_records',
          metaKey: 'nav_meta.usage_records',
          icon: sidebarIcons.usageRecords,
        },
        {
          path: '/logs',
          labelKey: 'nav.logs',
